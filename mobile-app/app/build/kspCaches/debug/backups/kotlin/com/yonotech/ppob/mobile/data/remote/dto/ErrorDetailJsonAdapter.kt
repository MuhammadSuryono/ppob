...
public class ErrorDetailJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<ErrorDetail>() {
  ...
  override fun toString(): String = buildString(33) {
      append("GeneratedJsonAdapter(").append("ErrorDetail").append(')') }

  override fun fromJson(reader: JsonReader): ErrorDetail {
  ...
  override fun toJson(writer: JsonWriter, value_: ErrorDetail?) {
    if (value_ == null) {
